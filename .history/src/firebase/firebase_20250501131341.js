...
import {getAuth, signInWithPopup, GoogleAuthProvider, signInWithGithubPopupm signInGithubAuthProvider} from "firebase/auth"
...
export const signInWithGooglePopup = () => signInWithPopup(auth, provider1)
export const signInWithGithubPopup = () => signInWithGithubPopup(auth, provider2)
